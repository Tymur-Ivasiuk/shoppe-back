...
//DJANGO AJAX end
const baseUrl = window.location.origin + "/favorites/"

const add_to_favorites_url = baseUrl + 'add/'
const remove_from_favorites_url = baseUrl + 'remove/'
const favorites_api_url = baseUrl + 'api/'
...
const baseUrlCart = window.location.origin + "/cart-options/"

const add_cart_url = baseUrlCart + 'add'
const remove_cart_url = baseUrlCart + 'remove'
const clear_cart_url = baseUrlCart + 'clear'
